...
> **Source:** [http://intrologic.stanford.edu/chapters/chapter_06.html](http://intrologic.stanford.edu/chapters/chapter_06.html)  
...
| m ⇒ p ∨ q p ⇒ q m ⇒ q | m ⇒ p ∨ q | p ⇒ q |  | m ⇒ q | {¬ m , p , q } {¬ p , q } {¬ m , q } | {¬ m , p , q } | {¬ p , q } |  | {¬ m , q } |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| m ⇒ p ∨ q |  |  |  |  |  |  |  |  |  |
| p ⇒ q |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |
...
[Exercise 6.1:](http://intrologic.stanford.edu/exercises/exercise_06_01.html)  Convert the following sentences to clausal form.
...
[Exercise 6.2:](http://intrologic.stanford.edu/exercises/exercise_06_02.html) What are the results of applying Propositional Resolution to the following pairs of clauses.
...
[Exercise 6.3:](http://intrologic.stanford.edu/exercises/exercise_06_03.html) Use Propositional Resolution to show that the clauses {*p*, *q*}, {¬*p*, *r*}, {¬*p*, ¬*r*}, {*p*, ¬*q*} are not simultaneously satisfiable.

[Exercise 6.4:](http://intrologic.stanford.edu/exercises/exercise_06_04.html) Given the premises (*p* ⇒ *q*) and (*r* ⇒ *s*), use Propositional Resolution to prove the conclusion (*p* ∨ *r* ⇒ *q* ∨ *s*).
