...
|-------------|------------|---------|------|--------|
| FS1 Events & Labels | Features, labels, acquisition | CS229, CS106 | EONET | `fs1_events_labels/` |
...
| FS5 Capstone | Multi-source fusion (prefers prior `out/`) | CS229+EE263+CS223A | All three | `fs5_capstone/` |
